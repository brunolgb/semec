...
<body>
	...
	<div class="controle_geral">
		<div class="titulos_paginas">
			<span>
				<a href="../../">Início</a> / <a href="../">Transferências</a> / Cadastro de Transferências
			</span>
		</div>
		<?php
		...
		<div class="formularios">
			...
			<div class="controle_campos">
				<div class="campos t100">
					<label for="documento">Documento requerido</label>
					<input type="text" name="documento" id="documento" maxlength="100">
				</div>
				<div class="campos t100">
					<label for="data_requerimento">Data do requerimento</label>
