...
// ------------
	...
	function meses($mesBuscar,$cone)
	{
		echo "<tbody>";
		echo "<tr>";
		$comando = "select * from calendarioEscolar2";
		...
		while ($a = mysqli_fetch_array($query))
		{
			...
			switch ($evento)
			{
				...
				case 'integral':	$title = "Integral";break;
	...
	<div class="cad" id="cadastrar">
		...
		<aside>
			...
			<select name="evento" id="evento">
				...
				<option value="reposicaopreF">Reposição Pré e Fundamental I</option>
				<option value="reposicaof">Reposição Fundamental II</option>
			</select>
		</aside>
		<aside>
		...
		<?php
			if (isset($_POST['salvar']) and $_POST['idEscondido'] !=null)
			{
				...
				$salvarCalend = "UPDATE calendarioEscolar2 SET data='".$dataCalendario."', evento='".$eventoCalendario."', obs='".$obsCalendario."' WHERE idCalenEscolar='".$idCalendario."'";
		...
		?>
	<!-- </div> -->
	<a href="calendario-final-rural.php">Ver resultado final</a>
			...
			<div class="legenda">
				<table>
					<tbody>
						...
						<tr>
							<td class="cor integral"></td>
							<td>Integral</td>
						</tr>
						<tr>
							<td class="cor reposicaopreF"></td>
							<td>Reposição Pré e Fundamental I</td>
						</tr>
						<tr>
							<td class="cor reposicaof"></td>
							<td>Reposição Fundamental II</td>
						</tr>
					</tbody>
				</table>
			</div>
