...
<head>
    ...
    <title>SEMEC - CADASTRO DE ARQUIVO PASSIVO</title>
</head>
<body>
           ...
           <div class="form-pattern">
               <form action='./registration.php' method="post">
                   ...
                   <div class="fieldControl">
                    ...
                    <div class="fieldControl">
                        <div class="fieldForm tam100">
                            <label for="boxStorageLetters">Letra da caixa</label>
                            <input type="text" name='boxStorageLetters' id='boxStorageLetters' value="<?php echo $boxStorageLetters; ?>" mask-year maxlength='1' required>
                        </div>
                        <div class="fieldForm tam100">
                            <label for="boxStorageNumber">Número da caixa</label>
                            <input type="number" name='boxStorageNumber' id='boxStorageNumber' value="<?php echo $boxStorageNumber; ?>" mask-year maxlength='12' required>
                        </div>
                    </div>
                    <div class="tam100">
